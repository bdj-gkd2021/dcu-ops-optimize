...
// launch_moe_w8a8_second_stage_prefill — sliced from moe/csrc_for_aiter/moe_w8a8_opt.h
#ifndef MOE_MARLIN_PREFILL_LAUNCH_INC_H
#define MOE_MARLIN_PREFILL_LAUNCH_INC_H
...
// Host-side launcher (Marlin path only). Template args must match a live entry in
// moe kernel_maps_gemm2_prefill (see moe/csrc_for_aiter/moe_w8a8_config.h). Default below
// matches mode 86: launch_moe_w8a8_second_stage_prefill<32,128,64,32,32,64,2>.
...
void launch_moe_w8a8_second_stage_prefill(const GemmParams<T, T_hidden>& params,
  ...
  MOE_W8A8_I8_PERCHANNEL_MARLIN_HIP_NT_PREFILL_DOWN<
      T_hidden,
      char,
      WARP_NUM,
      BLOCK_SIZE_M,
...
#endif /* MOE_MARLIN_PREFILL_LAUNCH_INC_H */
